...
'errInvDirname':'Nom de dossier incorrect.',
...
'errMkOutLink':'Impossible de créer un lien en dehors du volume principal.',
...
'errUploadTemp':'Impossible de créer un fichier temporaire pour transférer les fichiers.',
'errNotReplace':'L\'objet "$1" existe déjà à cet endroit et ne peut être remplacé par un objet d\'un type différent.',
...
'errResizeRotate':'L\'image ne peut pas être tournée.',
'errResizeSize':'Dimension de l\'image non-valide.',
'errResizeNoChange':'L\'image n\'est pas redimensionnable.',
'errUsupportType':'Type de fichier non supporté.',
'errNotUTF8Content':'Le fichier "$1" n\'est pas en UTF-8, il ne peut être édité.',
'errNetMount':'Impossible de monter "$1".',
'errNetMountNoDriver':'Protocol non supporté.',
'errNetMountFailed':'Echec du montage.',
'errNetMountHostReq':'Hôte requis.',
...
'errFolderUpload':'Essayez Google Chrome, si voulez envoyer le dossier.',
'errSearchTimeout':'Délai d’attente dépassé pour la recherche "$1". Le résultat de la recherche est partiel.',
'errReauthRequire':'Réauthorisation requise.',
'errMaxTargets':'Le nombre maximal de fichiers pouvant être sélectionné est $1.',
'errRestore':'Impossible de restorer la corbeille. La destination de la restoration n\'a pu être identifiée.',
'errEditorNotFound':'Aucun éditeur n\'a été trouvé pour ce type de fichier.',
'errServerError':'Un erreur est survenue du côté serveur.',
...
'cmdmkdirin':'Dans un nouveau dossier',
...
'cmdnetunmount': 'Démonter',
'cmdplaces':'Vers Places',
'cmdchmod':'Changer de mode',
'cmdopendir':'Ouvrir un dossier',
'cmdcolwidth':'Réinitialiser largeur colone',
'cmdfullscreen': 'Plein écran',
'cmdmove':'Déplacer',
'cmdempty':'Vider le dossier',
'btnClose':'Fermer',
'btnSave':'Sauvegarder',
'btnRm':'Supprimer',
'btnApply':'Confirmer',
...
'btnYes':'Oui',
'btnMount':'Monter',
'btnApprove': 'Aller à $1 & approuver',
'btnUnmount': 'Démonter',
'btnConv':'Convertir',
'btnCwd':'Ici',
'btnVolume':'Volume',
'btnAll':'Tous',
'btnMime':'Type MIME',
'btnFileName':'Nom du fichier',
'btnSaveClose': 'Enregistrer & Ferme',
'btnBackup':'Sauvegarde',
'btnRename':'Renommer',
'btnRenameAll':'Renommer (tous)',
'btnPrevious':'Préc. ($1/$2)',
'btnNext':'Suiv. ($1/$2)',
'btnSaveAs':'Sauvegarder sous',
...
'ntfnetmount':'Monte le volume réseau',
'ntfnetunmount': 'Démonte le volume réseau',
'ntfdim':'Calcule la dimension de l\'image',
'ntfreaddir':'Lecture des informations du dossier',
'ntfurl':'Récupération de l’URL du lien',
'ntfchmod':'Changement de mode',
'ntfpreupload': 'Vérification du nom du fichier envoyé',
'ntfzipdl':'Création d’un fichier pour le téléchargement',
'ntfparents':'Traitement de l\'information du chemin',
'ntfchunkmerge': 'Traitement du fichier envoyé',
'ntftrash':'Doing throw in the trash',
'ntfrestore':'Doing restore from tha trash',
'ntfchkdir':'Validation du dossier de destination',
'volume_Trash':'Corbeille',
...
'confirmRest':'Remplacer le fichier existant par le fichier dans la corbeille?',
'confirmConvUTF8':'L\'encodage n\'est pas UTf-8<br/>Convertir en UTF-8?<br/>Les contenus deviendront UTF-8 en sauvegardant après la conversion.',
...
'confirmNotSave':'Ce fichier a été modifié.<br/>Les données seront perdues si les changements ne sont pas sauvegardés.',
'confirmTrash':'Êtes-vous certain de vouloir déplacer les fichiers vers la corbeille?',
...
'restoreFiles':'Restorer les fichiers',
...
'degree':'°',
'netMountDialogTitle':'Monter un volume réseau',
'protocol':'Protocole',
'host':'Hôte',
'port':'Port',
'user':'Utilisateur',
'pass':'Mot de passe',
'confirmUnmount':'Démonter $1?',
'dropFilesBrowser': 'Glissez-déposez depuis le navigateur de fichier',
'dropPasteFiles':'Glissez-déposez les fichiers ici',
'encoding':'Encodage',
'locale':'Encodage régional',
'searchTarget':'Destination: $1',
'searchMime':'Recherche par type MIME',
'owner':'Propriétaire',
'group':'Groupe',
'other':'Autre',
'execute':'Exécuter',
...
'emptyFolderDrop':'Le dossier est vide.\\ Glissez-déposez pour ajouter des éléments.',
'emptyFolderLTap':'Le dossier est vide.\\ Un appui long pour ajouter des éléments.',
'quality':'Qualité',
'autoSync':'Synchronisation automatique',
'moveUp':'Déplacer vers le haut',
'getLink':'Obtenir le lien d’URL',
'selectedItems':'Éléments sélectionnés ($1)',
'folderId':'ID du dossier',
'offlineAccess':'Permettre l\'accès offline',
'reAuth':'Pour se réauthentifier',
'nowLoading':'En cours de chargement...',
'openMulti':'Ouvrir multiples fichiers',
...
'hasSelected':'Vous avez sélectionné $1 fichier.',
'hasClipboard':'Vous avez $1 items dans le clipboard.',
'incSearchOnly':'La recherche incrémentale est seulement pour la vue active.',
'reinstate':'Reinstate',
'complete':'$1 complété',
...
'enabled':'Actif',
'disabled':'Inactif',
'emptyIncSearch':'Search results is empty in current view.\\APress [Enter] to expand search target.',
'emptyLetSearch':'First letter search results is empty in current view.',
'textLabel':'Text label',
'minsLeft':'$1 mins restants',
'openAsEncoding':'Réouvrir avec l\'encodage sélectionné',
'saveAsEncoding':'Sauvegarder avec l\'encodage sélectionné',
'selectFolder':'Choisir le dossier',
'firstLetterSearch': 'Recherche par première lettre',
'presets':'Presets',
...
'clearBrowserData': 'Initialisation des configurations sauvegardés dans ce navigateur',
'kindUnknown':'Inconnu',
'kindRoot':'Volume principal',
'kindFolder':'Dossier',
'kindAlias':'Raccourci',
