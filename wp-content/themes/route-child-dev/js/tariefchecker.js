/* ************************************************ */
/*       Wordt gebruikt voor leveranciersfiches     */
/* /energie/energieleveranciers-belgie/edf-luminus/ */
/* ************************************************ */
...
function descriptions(results,supplier) {
  ...
  for (var i = keys.length - 1; i >= 0; i--) {
      ...
      if(result.product_type == 'pack'){
        //html += '<p><strong class="dark">Tariefkaarten:</strong> <a href="/energie/tariefkaarten/'+ year +'/'+ month_nr +'-'+ month_full +'/'+ supplier_url +'/particulieren/elektriciteit/'+ pdffile +'">Elektriciteit</a> <span class="gasvergelijken">/ <a href="/energie/tariefkaarten/'+ year +'/'+ month_nr +'-'+ month_full +'/'+ supplier_url +'/particulieren/aardgas/'+ pdffile +'">Gas</a></span></p>';
