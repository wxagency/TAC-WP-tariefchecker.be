 ...
 */
 ...
 <?php
    $kd_post_content = $blog_template_class = $page_layout = $section_style = $sticky_sidebar = $blog_active_widgets = $blog_sidebar = $blog_template = '';
   ...
   $blog_sidebar = sway_get_option ( 'tek-blog-sidebar' );
   ...
   if ( $blog_sidebar ) {
     $page_layout .= "use-sidebar";
 	 ...
 	 if ( sway_get_option( 'tek-blog-listing-sticky-sidebar' ) ) {
