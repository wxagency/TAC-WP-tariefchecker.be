...
if(ICL_LANGUAGE_CODE=="fr"){ 
                      $return .= '<form action="https://comparateurenergie.veriftarif.be/consumption-details" method="post" target="_blank">';
                      $return .= '<input type="hidden" name="locale"  value="fr">';
                      
  }else{
          $return .= '<form action="https://energievergelijker.tariefchecker.be/consumption-details" method="post" target="_blank">';
           $return .= '<input type="hidden" name="locale"  value="nl">';
  } 
            ...
            <input type="hidden" id="comparison_type" name="comparison_type" class="hidden test8888" value="p">
               ...
               <div class="row producttypeswrap">
                  <div class="'.$ctafootercol_left.' producttypes">
                      <span class="checkboxli input prepend"><label for="gas_'.$i.'" class="alt-checkbox fontawesome-ok medium outline-unchecked checked checkbox" href="#">&nbsp;</label><input checked="checked" id="gas_'.$i.'" class="cbinput" name="gas" type="checkbox" value="gas"> <span>';
if(ICL_LANGUAGE_CODE=="fr"){ 
                      $return .= 'Gaz';
  }else{
          $return .= 'Gas';
                      ...
                      $return .= '</span></span>
                      <span class="checkboxli input"><label for="electricity_'.$i.'" class="alt-checkbox fontawesome-ok medium outline-unchecked checked checkbox" href="#">&nbsp;</label><input checked="checked" id="electricity_'.$i.'" class="cbinput" name="elec" type="checkbox" value="electricity"> <span>';
if(ICL_LANGUAGE_CODE=="fr"){ 
                      $return .= 'Electricité';
  }else{
          $return .= 'Elektriciteit';
                  ...
                  <div class="'.$ctafootercol_right.'">
                    ...
                    if(ICL_LANGUAGE_CODE=="fr"){ 
                                          $return .= '<input autocomplete="off" autofocus="autofocus" data-bind="value: location.postal_code, valueUpdate: \'keyup\'" id="postal_code" name="po" placeholder="Code Postal" type="text">';
                      }else{
                              $return .= '<input autocomplete="off" autofocus="autofocus" data-bind="value: location.postal_code, valueUpdate: \'keyup\'" id="postal_code" name="po" placeholder="Postcode" type="text">';
                      }                
