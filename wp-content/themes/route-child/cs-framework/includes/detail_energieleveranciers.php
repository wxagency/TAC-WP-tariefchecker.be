...
function detail_goedkoopste_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   $return .= '<div class="col-md-3 col-sm-12 align-bottom">
     ...
     <div class="plan-select"><a class="lp-element lp-pom-button redbtn small" data-ps-product="Goedkoopste" data-ps-field="product_subscribe_url" data-ps-attribute="href" href="#" target="_blank">DEVENIR CLIENT</a></div>
   </div>';

   $return .= '<div class="col-md-9 col-sm-12">
     <div class="blue semibold"><span data-ps-field="name" data-ps-product="Goedkoopste">PRODUCT NAME</span> en bref:</div>
     <ul>
      <li><span data-ps-field="product_contract_duration" data-ps-product="Goedkoopste">CONTRACTDUUR</span> an(s)</li>
      <li><span data-ps-field="product_pricing_type" data-ps-product="Goedkoopste">PRIJS TYPE</span></li>
      <li><span class="Goedkoopste product_service_level" data-ps-product="Goedkoopste">SERVICE LEVEL</span></li>
      <li class="blue"><strong>Réduction de <span data-ps-field="price_promo_year" data-ps-product="Goedkoopste">PRICE DIFFERENCE</span></strong></li>
     </ul>
     <div class="condition">Uniquement pour les nouveaux clients inscrits <strong><span class="blue">via Veriftarif</span></strong> avant <strong>le '.date('t').'/'.date('m').'/'.date('Y').'</strong></div>
...
function goedkoopgroen_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   if(ICL_LANGUAGE_CODE=="fr"){ 
            ...
            <div class="plan-select"><a class="lp-element lp-pom-button redbtn small" data-ps-product="Groene" data-ps-field="product_subscribe_url" data-ps-attribute="href" href="#" target="_blank">DEVENIR CLIENT</a></div>
            </div>';

            $return .= '<div class="col-md-9 col-sm-12">
            <div class="blue semibold"><span data-ps-field="name" data-ps-product="Groene">PRODUCT NAME</span> en bref:</div>
            <ul>
            <li><span data-ps-field="product_contract_duration" data-ps-product="Groene">CONTRACTDUUR</span> an(s)</li>
            <li><span data-ps-field="product_pricing_type" data-ps-product="Groene">PRIJS TYPE</span></li>
            <li><span class="Groene product_service_level" data-ps-product="Groene">SERVICE LEVEL</span></li>
            <li class="blue"><strong>Réduction de <span data-ps-field="price_promo_year" data-ps-product="Groene">PRICE DIFFERENCE</span></strong></li>
            </ul>
            <div class="condition">Uniquement pour les nouveaux clients inscrits <strong><span class="blue">via Veriftarif</span></strong> avant <strong>le '.date('t').'/'.date('m').'/'.date('Y').'</strong></div>
            <div class="plan-calculate"><a class="lp-element lp-pom-button" id="'.$tag.'" href="http://energievergelijker.tariefchecker.be" target="_blank">'.$vergelijktxt.'</a></div>
            </div>';
...
function goedkoopnormal_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   $return .= '<div class="col-md-3 col-sm-12">
     ...
     <div class="plan-select"><a class="lp-element lp-pom-button redbtn small" data-ps-product="1jrvast" data-ps-field="product_subscribe_url" data-ps-attribute="href" href="#" target="_blank">DEVENIR CLIENT</a></div>
   </div>';

      $return .= '<div class="col-md-9 col-sm-12">
     <div class="blue semibold"><span data-ps-field="name" data-ps-product="1jrvast">PRODUCT NAME</span> en bref:</div>
     <ul>
      <li><span data-ps-field="product_contract_duration" data-ps-product="1jrvast">CONTRACTDUUR</span> an(s)</li>
      <li><span data-ps-field="product_pricing_type" data-ps-product="1jrvast">PRIJS TYPE</span></li>
      <li><span class="1jrvast product_service_level" data-ps-product="1jrvast">SERVICE LEVEL</span></li>
      <li class="blue"><strong>Réduction de <span data-ps-field="price_promo_year" data-ps-product="1jrvast">PRICE DIFFERENCE</span></strong></li>
     </ul>
     <div class="condition">Uniquement pour les nouveaux clients inscrits <strong><span class="blue">via Veriftarif</span></strong>avant<strong>le '.date('t').'/'.date('m').'/'.date('Y').'</strong></div>
     <div class="plan-calculate"><a class="lp-element lp-pom-button" id="'.$tag.'" href="http://energievergelijker.tariefchecker.be" target="_blank">'.$vergelijktxt.'</a></div>
   </div>';
...
function goedkoop3jr_func( $atts, $content = null ) { // New function parameter $content is added!
   ...
   $return .= '<div class="col-md-3 col-sm-12">
     ...
     <div class="plan-select"><a class="lp-element lp-pom-button redbtn small" data-ps-product="3jrvast" data-ps-field="product_subscribe_url" data-ps-attribute="href" href="#" target="_blank">DEVENIR CLIENT</a></div>
   </div>';

    $return .= '<div class="col-md-9 col-sm-12">
     <div class="blue semibold"><span data-ps-field="name" data-ps-product="3jrvast">PRODUCT NAME</span> en bref:</div>
     <ul>
      <li><span data-ps-field="product_contract_duration" data-ps-product="3jrvast">CONTRACTDUUR</span> an(s)</li>
      <li><span data-ps-field="product_pricing_type" data-ps-product="3jrvast">PRIJS TYPE</span></li>
      <li><span class="3jrvast product_service_level" data-ps-product="3jrvast">SERVICE LEVEL</span></li>
      <li class="blue"><strong>Réduction de <span data-ps-field="price_promo_year" data-ps-product="3jrvast">PRICE DIFFERENCE</span></strong></li>
     </ul>
     <div class="condition">Uniquement pour les nouveaux clients inscrits <strong><span class="blue">via Veriftarif</span></strong> avant <strong>le '.date('t').'/'.date('m').'/'.date('Y').'</strong></div>
     <div class="plan-calculate"><a class="lp-element lp-pom-button" id="'.$tag.'" href="http://energievergelijker.tariefchecker.be" target="_blank">'.$vergelijktxt.'</a></div>
   </div>';
