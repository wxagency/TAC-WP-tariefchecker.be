...
function vc_goedkoopste() {
  ...
  $params = array(
    array(
     ...
     array(
        "type" => "textfield",
        "heading" => __( "Category Type", "content-box" ),
        "param_name" => "api_category_type",
        'value'       => '',
      ),
    array(
        "type" => "textfield",
...
//print_r($api_comparison_type);
   ...
   if(ICL_LANGUAGE_CODE=="fr"){ 
     ...
     $return = '<div class="snip1214">
<input type="hidden" value = "'.$api_comparison_type.'" id="api_comparison_type">
<input type="hidden" value = "fr" id="api_locale">
...
<input type="hidden" value = "'.$api_category_type.'" id="api_category_type">
...
<div class="snip1214">
<input type="hidden" value = "'.$api_comparison_type.'" id="api_comparison_type">
<input type="hidden" value = "nl" id="api_locale">
<input type="hidden" value = "'.$api_postal_code.'" id="api_postal_code">
<input type="hidden" value = "'.$api_usage_single.'" id="api_usage_single">
<input type="hidden" value = "'.$api_usage_gas.'" id="api_usage_gas">
<input type="hidden" value = "'.$api_only_energy_cost.'" id="api_only_energy_cost">
...
if($groene):
         $return .= '<div class="plan">
           <div class="plancontainer borderright">
               <div class="plan-subtitle">Energie <span class="green">verte</span> la moins chère</div>
               ...
               <div class="plan-features">
                  <span data-ps-field="$delta" data-ps-product="Groene">PRICE DIFFERENCE</span>/an en plus que le fournisseur le moins cher.
               </div>
    ...
    if($jrvast1):
        ...
        if(!$allergoedkoopste):
           ...
           $return .= '
               <div class="plan-subtitle">Meilleur tarif fixe "1 an"</div>
               <div class="plan-image lp-element lp-pom-text">
               ...
               <div class="plan-features">
                  <span data-ps-field="$delta" data-ps-product="1jrvast">PRICE DIFFERENCE</span>/an en plus que le fournisseur le moins cher.
               </div>
   ...
   if($allergoedkoopste):
         $return .= '<div class="plan featured">
             ...
             <div class="plancontainer">
                 <div class="plan-subtitle">Fournisseur d\'énergie le moins cher</div>
                 <div class="plan-image lp-element lp-pom-text">
                 ...
                 <div class="plan-features">
                    Maintenant avec une réduction de <span class="blue"><span data-ps-field="price_promo_year" data-ps-product="Goedkoopste">PRICE DIFFERENCE</span></span> via <span class="blue"> Veriftarif.be</span>.
                 </div>
   ...
   if($jrvast3):
         $return .= '<div class="plan j3">
           <div class="plancontainer">
             <div class="plan-subtitle">Meilleur tarif fixe "3 ans"</div>
             <div class="plan-image lp-element lp-pom-text">
             ...
             <div class="plan-features">
                <span data-ps-field="$delta" data-ps-product="3jrvast">PRICE DIFFERENCE</span>/an en plus que le fournisseur le moins cher.
             </div>
...
<input type="hidden" value="'.$_COOKIE['analytics_id'].'" id="analytic_id">
